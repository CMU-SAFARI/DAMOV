...
TracingCache::TracingCache(uint32_t _numLines, CC* _cc, CacheArray* _array, ReplPolicy* _rp, uint32_t _accLat, uint32_t _invLat, g_string& _tracefile, bool _bypass, g_string& _name) :
    Cache(_numLines, _cc, _array, _rp, _accLat, _invLat, _bypass, _name), tracefile(_tracefile), bypass(_bypass)
{
