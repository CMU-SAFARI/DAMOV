...
static void printHeartbeat(GlobSimInfo* zinfo) {
    ...
    string pathSrc = zinfo->outputDir;
    string tmp = pathSrc +"/"+application_name+".heartbeat";
    /*std::ofstream hb(tmp.c_str());
    ...
    hb << " " << zinfo->totalInstrs << " instructions" << std::endl;
...
int main(int argc, char *argv[]) {
    ...
    application_name = conf.get<const char*>("sim.stats");
